...
for fp in files:
    try:
        ...
        for i in range(60, len(data) - 5):
            ...
            f['ret5'] = (closes[i+5] - c) / c if i+5 < len(closes) else 0
            ...
            y_all.append(1 if f['ret5'] > 0.03 else 0)
...
model_path = MODEL_DIR / f"ml_nn_light_{timestamp}.pkl"
