...
print("="*70, flush=True)
print("神经网络训练 - 800股最大版", flush=True)
print("="*70, flush=True)
...
files = sorted(HISTORY_DIR.glob("*.json"))[:800]
...
# 使用更激进参数避免超时
model = MLPClassifier(
    hidden_layer_sizes=(64, 32),  # 更小网络
    activation='relu',
    solver='adam',
    learning_rate_init=0.02,  # 更高学习率
    max_iter=25,  # 更少迭代
    early_stopping=True,
