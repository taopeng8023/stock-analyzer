...
print("="*70, flush=True)
print("神经网络训练 - 1500股版", flush=True)
print("="*70, flush=True)
...
files = sorted(HISTORY_DIR.glob("*.json"))[:1500]
