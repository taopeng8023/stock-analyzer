...
files = sorted(HISTORY_DIR.glob("*.json"))[:700]
...
# 使用更深的网络尝试提升性能
model = MLPClassifier(
    hidden_layer_sizes=(256, 128),  # 更深网络
    activation='relu',
    solver='adam',
