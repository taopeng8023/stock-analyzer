...
print("="*70, flush=True)
print("神经网络训练 - 400股快速版", flush=True)
print("="*70, flush=True)
...
files = sorted(HISTORY_DIR.glob("*.json"))[:400]
