...
def main():
    ...
    parser.add_argument("--workspace", "-w", default=os.environ.get("OPENCLAW_WORKSPACE", "/root/.openclaw/workspace"), help="Workspace directory")
    
    args = parser.parse_args()
    
    sia = SelfImprovingAgent(workspace=args.workspace)
